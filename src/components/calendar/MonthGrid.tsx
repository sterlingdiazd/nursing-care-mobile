...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: "row", paddingBottom: designTokens.spacing.sm },
  weekday: { flex: 1, textAlign: "center", color: T.color.ink.muted, fontSize: designTokens.typography.caption.fontSize, fontWeight: "800", textTransform: "uppercase" },
  ...
  dayNum: { color: T.color.ink.primary, fontSize: designTokens.typography.body.fontSize, fontWeight: "700" },
