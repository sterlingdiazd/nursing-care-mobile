...
const styles = StyleSheet.create({
  headerActions: { flexDirection: "row", gap: designTokens.spacing.sm, flexWrap: "wrap" },
  ...
  buttonActive: { backgroundColor: designTokens.color.surface.accent, borderColor: designTokens.color.border.accent },
  buttonTextActive: { color: designTokens.color.ink.accent },
  buttonPrimary: { backgroundColor: designTokens.color.ink.accent, borderRadius: designTokens.radius.md, paddingHorizontal: designTokens.spacing.lg, paddingVertical: designTokens.spacing.md },
  ...
  loadingContainer: { flex: 1, justifyContent: "center", alignItems: "center", padding: designTokens.spacing.huge },
  loadingText: { marginTop: designTokens.spacing.md, fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.secondary },
  ...
  cardsContainer: { gap: designTokens.spacing.md },
  cardActions: { flexDirection: "row", alignItems: "center", gap: designTokens.spacing.sm },
  cardChevron: { color: designTokens.color.ink.muted, fontSize: designTokens.typography.section.fontSize, lineHeight: 24 },
  previewButton: { paddingHorizontal: designTokens.spacing.md, paddingVertical: designTokens.spacing.sm, borderRadius: designTokens.radius.sm, backgroundColor: designTokens.color.surface.accent, borderWidth: 1, borderColor: designTokens.color.border.accent },
  previewButtonText: { fontSize: designTokens.typography.caption.fontSize, color: designTokens.color.ink.accentStrong, fontWeight: "600" },
  previewLoadingRow: { flexDirection: "row", alignItems: "center", gap: designTokens.spacing.md, paddingVertical: designTokens.spacing.md },
  previewLoadingText: { fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.secondary },
  previewResultCard: { ...mobileSurfaceCard, padding: designTokens.spacing.lg },
  previewTypeLabel: { fontSize: designTokens.typography.label.fontSize, color: designTokens.color.ink.muted, marginBottom: designTokens.spacing.md },
  previewRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: designTokens.spacing.md, borderBottomWidth: 1, borderBottomColor: designTokens.color.surface.canvas },
  previewRowLabel: { fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.secondary },
  previewRowValue: { fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.primary, fontWeight: "600" },
  previewTotalRow: { borderBottomWidth: 0, marginTop: designTokens.spacing.xs, paddingTop: designTokens.spacing.lg },
  previewTotalLabel: { fontSize: designTokens.typography.body.fontSize, fontWeight: "700", color: designTokens.color.ink.primary },
  previewTotalValue: { fontSize: designTokens.typography.section.fontSize, fontWeight: "800", color: designTokens.color.ink.accent },
  emptyState: { padding: designTokens.spacing.xxxl, alignItems: "center" },
  emptyStateText: { fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.secondary },
  formGroup: { marginBottom: designTokens.spacing.lg },
  formLabel: { fontSize: designTokens.typography.body.fontSize, fontWeight: "600", color: designTokens.color.ink.primary, marginBottom: designTokens.spacing.sm },
  formInput: { backgroundColor: designTokens.color.ink.inverse, borderWidth: 1, borderColor: designTokens.color.border.strong, borderRadius: designTokens.radius.md, padding: designTokens.spacing.lg, fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.primary },
  checkboxRow: { flexDirection: "row", alignItems: "center", marginBottom: designTokens.spacing.lg },
  checkbox: { width: 24, height: 24, borderRadius: designTokens.radius.sm, borderWidth: 2, borderColor: designTokens.color.border.strong, backgroundColor: designTokens.color.ink.inverse, justifyContent: "center", alignItems: "center", marginRight: designTokens.spacing.md },
  checkboxChecked: { backgroundColor: designTokens.color.ink.accent, borderColor: designTokens.color.ink.accent },
  checkmark: { color: designTokens.color.ink.inverse, fontSize: designTokens.typography.body.fontSize, fontWeight: "700" },
  checkboxLabel: { fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.primary },
});
