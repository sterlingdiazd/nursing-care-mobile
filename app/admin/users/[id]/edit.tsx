...
export default function AdminUserEditScreen() {
  ...
  useEffect(() => {
    ...
    getAdminUserDetail(id)
      ...
      .catch((err: unknown) => {
        if (cancelled) return;
        setServerError(err instanceof Error ? err.message : "No se pudo cargar el usuario.");
      })
      .finally(() => {
  ...
  const workflowActions: FooterAction[] = [
    {
      ...
      testID: "admin-user-edit-cancel-button",
    },
    {
      ...
      variant: "primary",
      disabled: !isDirty || isSaving,
      testID: "admin-user-edit-save-button",
    },
  ];

  return (
    <MobileWorkspaceShell
      title={detail ? `Editar ${detail.displayName}` : "Editar Usuario"}
      onPrimaryReturn={() => goBackOrReplace(router, mobileNavigationEscapes.adminUsers)}
      primaryReturnLabel="Volver"
      testID="admin-user-edit-screen"
      nativeID="admin-user-edit-screen"
      ...
      {isFetching ? (
        ...
        <View style={styles.container}>
          ...
          <View style={styles.formCard}>
            <FormInput
              testID="admin-user-edit-name-input"
              label="Nombre"
              value={form.name}
            ...
            />
            <FormInput
              testID="admin-user-edit-last-name-input"
              label="Apellido"
              value={form.lastName}
            ...
            />
            <FormInput
              testID="admin-user-edit-identification-input"
              label="Cédula"
            ...
            />
            <FormInput
              testID="admin-user-edit-phone-input"
              label="Teléfono"
              value={form.phone}
            ...
            />
            <FormInput
              testID="admin-user-edit-email-input"
              label="Correo"
              value={form.email}
