...
const styles = StyleSheet.create({
  ...
  planLabel: { fontSize: designTokens.typography.section.fontSize, fontWeight: "800", color: designTokens.color.ink.primary },
  planMeta: { fontSize: designTokens.typography.caption.fontSize, color: designTokens.color.ink.muted, marginTop: designTokens.spacing.xs },
  nurseName: { fontSize: designTokens.typography.label.fontSize, color: designTokens.color.ink.secondary, marginTop: designTokens.spacing.xs, fontWeight: "600" },

  hero: { gap: designTokens.spacing.xs },
  heroLabel: { fontSize: designTokens.typography.caption.fontSize, fontWeight: "700", color: designTokens.color.ink.muted, textTransform: "uppercase", letterSpacing: 0.5 },
  heroValue: { fontSize: designTokens.typography.display.fontSize, fontWeight: "900", color: designTokens.color.ink.accentStrong },

  progressWrap: { gap: designTokens.spacing.sm },
  progressHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  progressText: { fontSize: designTokens.typography.caption.fontSize, color: designTokens.color.ink.secondary, fontWeight: "600" },
  progressPct: { fontSize: designTokens.typography.caption.fontSize, color: designTokens.color.ink.accentStrong, fontWeight: "800" },
  progressTrack: { height: 8, borderRadius: designTokens.radius.pill, backgroundColor: designTokens.color.surface.tertiary, overflow: "hidden" },
  progressFill: { height: 8, borderRadius: designTokens.radius.pill, backgroundColor: designTokens.color.ink.accent },
  ...
  factLabel: { fontSize: designTokens.typography.label.fontSize, color: designTokens.color.ink.muted },
  factValue: { fontSize: designTokens.typography.body.fontSize, fontWeight: "700", color: designTokens.color.ink.primary },
  ...
  installmentsList: { marginHorizontal: designTokens.spacing.lg, gap: designTokens.spacing.sm },
  installmentRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  installmentLeft: { flexDirection: "row", alignItems: "center", gap: designTokens.spacing.md, flex: 1 },
  installmentSeq: { fontSize: designTokens.typography.caption.fontSize, fontWeight: "800", color: designTokens.color.ink.muted, minWidth: 28 },
  installmentPeriod: { fontSize: designTokens.typography.label.fontSize, color: designTokens.color.ink.secondary, flex: 1 },
  installmentRight: { alignItems: "flex-end", gap: designTokens.spacing.sm },
  installmentAmount: { fontSize: designTokens.typography.body.fontSize, fontWeight: "800", color: designTokens.color.ink.primary },
  emptyText: { fontSize: designTokens.typography.body.fontSize, color: designTokens.color.ink.muted, padding: designTokens.spacing.lg, textAlign: "center" },
});
