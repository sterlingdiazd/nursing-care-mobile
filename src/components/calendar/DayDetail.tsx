...
const styles = StyleSheet.create({
  ...
  dayTitle: { color: T.color.ink.primary, fontSize: 16, fontWeight: "800" },
  empty: { color: T.color.ink.muted, fontSize: 14, paddingVertical: 8 },
  group: { gap: 8 },
  groupTitle: { color: T.color.ink.secondary, fontSize: 12, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.4 },
  ...
  client: { color: T.color.ink.primary, fontSize: 15, fontWeight: "700" },
  ...
  freeTitle: { color: T.color.ink.secondary, fontSize: 12, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.4 },
  freeEmpty: { color: T.color.ink.muted, fontSize: 13 },
  freeChips: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  freeChip: {
  ...
  freeChipText: { color: T.color.status.successText, fontSize: 13, fontWeight: "700" },
});
