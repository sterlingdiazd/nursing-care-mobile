...
export default function AdminReportsScreen() {
  ...
  return (
    <MobileWorkspaceShell
      ...
      description="Visualiza indicadores clave y exporta datos para analisis."
      actions={
        <Pressable
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontWeight: "700", color: "#52637a", textTransform: "uppercase", letterSpacing: 1, marginBottom: 12 },
  reportList: { flexDirection: "row" },
  reportCard: { backgroundColor: "#fff", paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: "#dbe5f3", marginRight: 10, minWidth: 120, alignItems: "center" },
  reportCardActive: { backgroundColor: "#132d75", borderColor: "#132d75" },
  reportLabel: { fontSize: 14, fontWeight: "600", color: "#132d75" },
  reportLabelActive: { color: "#fff" },
  dataContainer: { backgroundColor: "#fff", borderRadius: 24, padding: 20, minHeight: 400, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 },
  reportTitle: { fontSize: 20, fontWeight: "800", color: "#102a43", marginBottom: 4 },
  reportDescription: { fontSize: 13, color: "#52637a", marginBottom: 24, lineHeight: 18 },
  loaderContainer: { flex: 1, justifyContent: "center", alignItems: "center", paddingVertical: 60 },
  loaderText: { marginTop: 12, color: "#52637a", fontSize: 14 },
  emptyContainer: { flex: 1, justifyContent: "center", alignItems: "center", paddingVertical: 60 },
  emptyText: { color: "#52637a", fontSize: 14 },
  grid: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  stack: { gap: 12 },
  metricCard: { backgroundColor: "#f8fafc", borderRadius: 16, padding: 16, flex: 1, minWidth: "45%", borderWidth: 1, borderColor: "#f1f5f9" },
  metricLabel: { fontSize: 11, fontWeight: "700", color: "#64748b", textTransform: "uppercase", marginBottom: 4 },
  metricValue: { fontSize: 24, fontWeight: "800", color: "#1e293b" },
  table: { borderWidth: 1, borderColor: "#f1f5f9", borderRadius: 12, overflow: "hidden" },
  ...
  subTitle: { fontSize: 15, fontWeight: "700", color: "#1e293b", marginTop: 16, marginBottom: 8 },
  ...
  exportButton: { backgroundColor: "#132d75", paddingHorizontal: 14, paddingVertical: 8, borderRadius: 12 },
