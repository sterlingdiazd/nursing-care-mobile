        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.field}>
              ...
              <Text style={styles.fieldValue}>{formatDateSafe(detail.createdAtUtc)}</Text>
            </View>
              ...
              detail.careRequestHistory.map((item) => (
                ...
                >
                  ...
                  <Text style={styles.historyMeta}>
                    {item.careRequestDate ? formatDateSafe(item.careRequestDate) : "Fecha pendiente"} • {formatCurrency(item.total)}
                  </Text>
...
const styles = StyleSheet.create({
  ...
  historyMeta: { ...designTokens.typography.body, fontSize: designTokens.typography.caption.fontSize, color: designTokens.color.ink.muted, marginTop: designTokens.spacing.xs },
  ...
  statusBadgeText: { fontSize: designTokens.typography.caption.fontSize, fontWeight: "700" },
