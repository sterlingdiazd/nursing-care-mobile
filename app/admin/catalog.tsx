...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: designTokens.color.ink.inverse, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, borderWidth: 1, borderColor: designTokens.color.border.strong },
  ...
  formInput: { backgroundColor: designTokens.color.ink.inverse, borderWidth: 1, borderColor: designTokens.color.border.strong, borderRadius: 14, padding: 14, fontSize: 16, color: designTokens.color.ink.primary },
  checkboxRow: { flexDirection: "row", alignItems: "center", marginBottom: 16 },
  checkbox: { width: 24, height: 24, borderRadius: 6, borderWidth: 2, borderColor: designTokens.color.border.strong, backgroundColor: designTokens.color.ink.inverse, justifyContent: "center", alignItems: "center", marginRight: 12 },
