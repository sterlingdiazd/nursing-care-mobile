...
const styles = StyleSheet.create({
  ...
  notificationMeta: { ...designTokens.text.caption },
  statusDot: { borderRadius: designTokens.radius.pill, paddingHorizontal: designTokens.spacing.sm, paddingVertical: designTokens.spacing.xs },
  statusDotText: { ...designTokens.typography.caption, fontWeight: "900" },
  readHint: { ...designTokens.typography.label, color: designTokens.color.ink.accentStrong, fontWeight: "900" },
