...
const styles = StyleSheet.create({
  loadingState: {
    ...
    backgroundColor: designTokens.color.surface.canvas, padding: designTokens.spacing.xxl,
  },
  scroll: { flex: 1 },
  scrollContent: { paddingBottom: designTokens.spacing.lg, gap: designTokens.spacing.md },
  successBanner: {
    color: designTokens.color.status.successText,
    backgroundColor: designTokens.color.surface.success,
    fontSize: designTokens.typography.label.fontSize, fontWeight: "800",
    borderRadius: designTokens.radius.md, paddingHorizontal: designTokens.spacing.md, paddingVertical: designTokens.spacing.md,
  },
  errorBanner: {
  ...
  cardHeaderRow: {
    flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: designTokens.spacing.sm,
  },
  ...
  countPillText: {
    fontSize: designTokens.typography.caption.fontSize, fontWeight: "800",
  },
  servicioGrid: {
    flexDirection: "row", gap: designTokens.spacing.lg, marginTop: designTokens.spacing.xs,
  },
  ...
  sheetTitle: {
    color: designTokens.color.ink.primary, fontSize: designTokens.typography.section.fontSize, fontWeight: "900",
  },
  sheetSubtitle: {
    color: designTokens.color.ink.secondary, fontSize: designTokens.typography.label.fontSize, fontWeight: "700", marginTop: designTokens.spacing.xs,
  },
  sheetClose: {
  ...
  priceRowEmphasis: {
    borderTopWidth: 2, borderTopColor: designTokens.color.ink.accent, marginTop: designTokens.spacing.xs,
  },
  ...
  overflowActionText: {
    fontSize: designTokens.typography.body.fontSize, fontWeight: "900", color: designTokens.color.ink.primary,
  },
});
