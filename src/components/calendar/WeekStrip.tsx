...
const styles = StyleSheet.create({
  ...
  col: { flex: 1, alignItems: "center", paddingVertical: designTokens.spacing.sm, borderRadius: T.radius.md, gap: designTokens.spacing.xs },
  colSelected: { backgroundColor: T.color.ink.accent },
  colToday: { backgroundColor: T.color.surface.accent },
  weekday: { color: T.color.ink.muted, fontSize: designTokens.typography.caption.fontSize, fontWeight: "800", textTransform: "uppercase" },
  dayNum: { color: T.color.ink.primary, fontSize: designTokens.typography.body.fontSize, fontWeight: "800" },
  textSelected: { color: T.color.ink.inverse },
  dots: { flexDirection: "row", gap: designTokens.spacing.xs, height: 6, alignItems: "center" },
  dot: { width: 5, height: 5, borderRadius: designTokens.radius.sm },
  unassignedFlag: { position: "absolute", top: 4, right: 6, width: 6, height: 6, borderRadius: designTokens.radius.sm, backgroundColor: T.color.status.dangerText },
});
